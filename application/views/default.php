						...
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								...
								<span class="user-info">
									<small>Welcome,</small><?=$nama;?>
								</span>
								<i class="ace-icon fa fa-caret-down"></i>
							</a>
							<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								<li>
									<a id="profil" href="<?=site_url('report/profil');?>">
								...
								<li class="divider"></li>
								<li>
									<a href="<?php echo base_URL()?>report/logout">
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div id="sidebar" class="sidebar responsive ace-save-state">
				...
				<ul class="nav nav-list">
					...
					<li class="">
						<a href="<?=site_url('report/guru');?>">
							<i class="menu-icon fa fa-list-alt"></i>
							<span class="menu-text"> Biodata Guru </span>
						</a>
						<b class="arrow"></b>
					</li>
					<li class="">
						<a href="<?=site_url('report/peserta_didik');?>">
							<i class="menu-icon fa fa-list-alt"></i>
							<span class="menu-text"> Biodata Peserta Didik </span>
						</a>
						<b class="arrow"></b>
					</li>
					<li class="">
						<a href="<?=site_url('report/mapel');?>">
							<i class="menu-icon fa fa-list-alt"></i>
							<span class="menu-text"> Data Pelajaran </span>
						</a>
						<b class="arrow"></b>
					</li>
					<li class="">
					...
					<li class="">
						<a href="<?=site_url('report/wali_kelas');?>">
							<i class="menu-icon fa fa-list-alt"></i>
					...
					<li class="">
						<a href="<?=site_url('report/kelas_siswa');?>">
							<i class="menu-icon fa fa-list-alt"></i>
							<span class="menu-text"> Kelas dan Peserta Didik </span>
						</a>
						<b class="arrow"></b>
					</li>
					<li class="">
						<a href="<?=site_url('report/guru_mengajar');?>">
							<i class="menu-icon fa fa-list-alt"></i>
					...
					<li class="">
						<a href="<?=site_url('report/nilai');?>">
							<i class="menu-icon fa fa-list-alt"></i>
							<span class="menu-text"> Olah Nilai </span>
						</a>
						<b class="arrow"></b>
					</li>
					<li class="">
						<a href="<?=site_url('report/penghubung');?>">
							<i class="menu-icon fa fa-list-alt"></i>
							<span class="menu-text"> Olah Penghubung </span>
						</a>
						<b class="arrow"></b>
					</li>
					<li class="">
						<a href="<?=site_url('report/jadwal');?>">
							<i class="menu-icon fa fa-list-alt"></i>
					...
					<li class="">
						<a href="<?=site_url('report/kalender');?>">
							<i class="menu-icon fa fa-list-alt"></i>
