												...
												<div class="tabbable">
													...
													<div class="tab-content profile-edit-tab-content">
														<div id="edit-basic" class="tab-pane active">
															...
															<div class="form-group">
																<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Nama Orang Tua </label>
																<div class="col-sm-9">
																	<input id="form-field-1" placeholder="Nama Orang Tua" class="col-xs-10 col-sm-5" type="text" name="nama_ortu" value="<?=(isset($data)) ? $data->nama_ortu : ""?>">
																</div>
															</div>
															<div class="form-group">
															...
															<div class="form-group">
																...
																<div class="col-sm-9">
																	<input id="form-field-1" placeholder="Pekerjaan Orang Tua" class="col-xs-10 col-sm-5" type="text" name="pekerjaan" value="<?=(isset($data)) ? $data->pekerjaan : ""?>">
																</div>
															</div>
															<div class="form-group">
																<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> No Telp </label>
																<div class="col-sm-9">
																	<input id="form-field-1" placeholder="Nomor Telp" class="col-xs-10 col-sm-5" type="text" name="telp" value="<?=(isset($data)) ? $data->telp : ""?>">
																</div>
															</div>
														</div>
													</div>
