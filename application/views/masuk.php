...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Aplikasi Perkembangan Peserta Didik			
		</title>

		<meta name="description" content="Halaman Login" />
		<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0" />
		<!-- bootstrap & fontawesome -->			
		<link rel ="stylesheet" type="text/css" href="<?php echo base_url();?>assets/default/css/bootstrap.min.css" ></link rel ="stylesheet">				
		...
		<!-- ace styles -->
		<<link rel ="stylesheet" type="text/css" href="<?php echo base_url();?>assets/default/css/ace.min.css" >
					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								<h1>									
									<span class="red"></span>
									<span class="white" id="id-text2">Perkembangan Peserta Didik</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; ibeae</h4>
							</div>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action="<?php echo site_url('report/login') ?>" method="post">
												<fieldset>
